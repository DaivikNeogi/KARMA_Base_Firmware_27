...
C_SRCS += \
../state_machines/imu_sm.c 

O_SRCS += \
../state_machines/imu_sm.c.o 

OBJS += \
./state_machines/imu_sm.o 

C_DEPS += \
./state_machines/imu_sm.d 


# Each subdirectory must supply rules for building sources it contributes
state_machines/%.o state_machines/%.su state_machines/%.cyclo: ../state_machines/%.c state_machines/subdir.mk
...
clean: clean-state_machines

clean-state_machines:
	-$(RM) ./state_machines/imu_sm.cyclo ./state_machines/imu_sm.d ./state_machines/imu_sm.o ./state_machines/imu_sm.su

.PHONY: clean-state_machines
