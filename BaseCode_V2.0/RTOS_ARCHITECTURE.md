...
| File Path | Purpose |
| :--- | :--- |
| [Core/Inc/FreeRTOSConfig.h](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/Core/Inc/FreeRTOSConfig.h) | FreeRTOS configuration: 1 kHz tick rate, zero-heap static allocation, stack check level 2. |
| [Core/Src/main.c](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/Core/Src/main.c) | Peripheral setup, 9-clock I2C recovery, task manager initialization, and scheduler start. |
| [Core/Src/stm32f4xx_it.c](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/Core/Src/stm32f4xx_it.c) | FreeRTOS scheduler tick integration (`xPortSysTickHandler`) and exception routing. |
| [USB_DEVICE/App/usbd_cdc_if.c](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/USB_DEVICE/App/usbd_cdc_if.c) | Queue-based USB reception and semaphore-based transmit complete callbacks. |
| [tasks/task_manager.c](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/tasks/task_manager.c) | Static memory definitions for all queues, semaphores, mutexes, and tasks. |
| [tasks/motor_task.c](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/tasks/motor_task.c) | 100 Hz / 10 ms Motor control loop and 150 ms deadman safety watchdog. |
| [tasks/acquisition_task.c](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/tasks/acquisition_task.c) | 50 Hz / 20 ms Sensor acquisition task (Encoders, BNO085, Optical Flow, ToF). |
| [tasks/estimation_task.c](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/tasks/estimation_task.c) | 50 Hz / 20 ms Dead reckoning integration and robot state estimation. |
| [tasks/communication_task.c](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/tasks/communication_task.c) | Zero-alloc JSON command parsing, 50 Hz telemetry formatting, and USB flow control. |
| [tasks/jsmn.h](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/tasks/jsmn.h) | Lightweight, single-header in-place JSON tokenizer (zero-heap). |
| [algorithm.c](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/algorithm.c) | Dead reckoning mathematics ($R=35\,\text{mm}$, $W=150\,\text{mm}$, arc integration). |
| [logger.c](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/logger.c) | Mutex-protected static ring buffer logger with 500 ms software timer. |
| [drivers/i2c_recovery.c](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/drivers/i2c_recovery.c) | 9-clock SCL bit-banging and manual STOP routine for I2C3 bus lockups. |
| [drivers/hw_encoders.c](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/drivers/hw_encoders.c) | 3-channel encoder driver with two's-complement rollover delta tracking. |
| [drivers/motor_driver.c](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/drivers/motor_driver.c) | 4x MD30C motor driver with duty cycle compare writes and bounds checking. |
| [drivers/optical_flow_tof.c](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/drivers/optical_flow_tof.c) | Optical Flow and Time-of-Flight sensor data abstraction. |
| [drivers/bno085.c](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/drivers/bno085.c) | BNO085 hardware interface driven by state machine. |
| [state_machines/imu_sm.c](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/state_machines/imu_sm.c) | 2D State Matrix transition table for IMU lifecycle, error detection, and recovery. |
| [CMakeLists.txt](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/CMakeLists.txt) | Build configuration including FreeRTOS kernel, drivers, and tasks. |
...
1. Open [tasks/task_manager.h](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/tasks/task_manager.h#L20).
2. Change:
   ```c
   ...
   ```
3. Connect your sensor hardware pins and implement the SPI/I2C read logic inside [drivers/optical_flow_tof.c](file:///c:/Users/daivi/OneDrive/Desktop/BaseCode_V2.0/drivers/optical_flow_tof.c). Everything else (queues, task calls, and telemetry) will automatically integrate.
