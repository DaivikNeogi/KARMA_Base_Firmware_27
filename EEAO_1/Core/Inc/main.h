...
#define MDD_PWM4_Pin GPIO_PIN_6
#define MDD_PWM4_GPIO_Port GPIOB
#define MDD_PWM3_Pin GPIO_PIN_7
#define MDD_PWM3_GPIO_Port GPIOB
#define MDD_PWM2_Pin GPIO_PIN_8
#define MDD_PWM2_GPIO_Port GPIOB
#define MDD_PWM1___Pin GPIO_PIN_9
#define MDD_PWM1___GPIO_Port GPIOB
